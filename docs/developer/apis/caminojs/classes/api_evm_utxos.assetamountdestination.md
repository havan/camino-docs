...
- [StandardAssetAmountDestination](common_assetamount.standardassetamountdestination)‹[TransferableOutput](api_evm_outputs.transferableoutput), [TransferableInput](api_evm_inputs.transferableinput)›
...
- [constructor](api_evm_utxos.assetamountdestination#constructor)

### Properties

- [amountkey](api_evm_utxos.assetamountdestination#protected-amountkey)
- [amounts](api_evm_utxos.assetamountdestination#protected-amounts)
- [change](api_evm_utxos.assetamountdestination#protected-change)
- [changeAddresses](api_evm_utxos.assetamountdestination#protected-changeaddresses)
- [destinations](api_evm_utxos.assetamountdestination#protected-destinations)
- [inputs](api_evm_utxos.assetamountdestination#protected-inputs)
- [outputs](api_evm_utxos.assetamountdestination#protected-outputs)
- [senders](api_evm_utxos.assetamountdestination#protected-senders)

### Methods

- [addAssetAmount](api_evm_utxos.assetamountdestination#addassetamount)
- [addChange](api_evm_utxos.assetamountdestination#addchange)
- [addInput](api_evm_utxos.assetamountdestination#addinput)
- [addOutput](api_evm_utxos.assetamountdestination#addoutput)
- [assetExists](api_evm_utxos.assetamountdestination#assetexists)
- [canComplete](api_evm_utxos.assetamountdestination#cancomplete)
- [getAllOutputs](api_evm_utxos.assetamountdestination#getalloutputs)
- [getAmounts](api_evm_utxos.assetamountdestination#getamounts)
- [getAssetAmount](api_evm_utxos.assetamountdestination#getassetamount)
- [getChangeAddresses](api_evm_utxos.assetamountdestination#getchangeaddresses)
- [getChangeOutputs](api_evm_utxos.assetamountdestination#getchangeoutputs)
- [getDestinations](api_evm_utxos.assetamountdestination#getdestinations)
- [getInputs](api_evm_utxos.assetamountdestination#getinputs)
- [getOutputs](api_evm_utxos.assetamountdestination#getoutputs)
- [getSenders](api_evm_utxos.assetamountdestination#getsenders)

## Constructors

### constructor

\+ **new AssetAmountDestination**(`destinations`: Buffer[], `senders`: Buffer[], `changeAddresses`: Buffer[]): _[AssetAmountDestination](api_evm_utxos.assetamountdestination)_
...
**Returns:** _[AssetAmountDestination](api_evm_utxos.assetamountdestination)_
...
• **change**: _[TransferableOutput](api_evm_outputs.transferableoutput)[]_ = []
...
• **inputs**: _[TransferableInput](api_evm_inputs.transferableinput)[]_ = []
...
• **outputs**: _[TransferableOutput](api_evm_outputs.transferableoutput)[]_ = []
...
▸ **addChange**(`output`: [TransferableOutput](api_evm_outputs.transferableoutput)): _void_
...
| Name     | Type                                                     |
| -------- | -------------------------------------------------------- |
| `output` | [TransferableOutput](api_evm_outputs.transferableoutput) |
...
▸ **addInput**(`input`: [TransferableInput](api_evm_inputs.transferableinput)): _void_
...
| Name    | Type                                                  |
| ------- | ----------------------------------------------------- |
| `input` | [TransferableInput](api_evm_inputs.transferableinput) |
...
▸ **addOutput**(`output`: [TransferableOutput](api_evm_outputs.transferableoutput)): _void_
...
▸ **getAllOutputs**(): _[TransferableOutput](api_evm_outputs.transferableoutput)[]_
...
▸ **getChangeOutputs**(): _[TransferableOutput](api_evm_outputs.transferableoutput)[]_
...
▸ **getInputs**(): _[TransferableInput](api_evm_inputs.transferableinput)[]_
...
▸ **getOutputs**(): _[TransferableOutput](api_evm_outputs.transferableoutput)[]_
