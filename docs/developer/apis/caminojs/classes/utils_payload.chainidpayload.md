...
- [constructor](utils_payload.chainidpayload#constructor)

### Properties

- [payload](utils_payload.chainidpayload#protected-payload)
- [typeid](utils_payload.chainidpayload#protected-typeid)

### Methods

- [fromBuffer](utils_payload.chainidpayload#frombuffer)
- [getContent](utils_payload.chainidpayload#getcontent)
- [getPayload](utils_payload.chainidpayload#getpayload)
- [returnType](utils_payload.chainidpayload#returntype)
- [toBuffer](utils_payload.chainidpayload#tobuffer)
- [typeID](utils_payload.chainidpayload#typeid)
- [typeName](utils_payload.chainidpayload#typename)

## Constructors

### constructor

\+ **new CHAINIDPayload**(`payload`: any): _[CHAINIDPayload](utils_payload.chainidpayload)_
...
**Returns:** _[CHAINIDPayload](utils_payload.chainidpayload)_
...
_Defined in [src/utils/payload.ts:552](https://github.com/chain4travel/caminojs/blob/3883166/src/utils/payload.ts#L552)_
