...
- [constructor](utils_payload.subnetidpayload#constructor)

### Properties

- [payload](utils_payload.subnetidpayload#protected-payload)
- [typeid](utils_payload.subnetidpayload#protected-typeid)

### Methods

- [fromBuffer](utils_payload.subnetidpayload#frombuffer)
- [getContent](utils_payload.subnetidpayload#getcontent)
- [getPayload](utils_payload.subnetidpayload#getpayload)
- [returnType](utils_payload.subnetidpayload#returntype)
- [toBuffer](utils_payload.subnetidpayload#tobuffer)
- [typeID](utils_payload.subnetidpayload#typeid)
- [typeName](utils_payload.subnetidpayload#typename)

## Constructors

### constructor

\+ **new SUBNETIDPayload**(`payload`: any): _[SUBNETIDPayload](utils_payload.subnetidpayload)_
...
**Returns:** _[SUBNETIDPayload](utils_payload.subnetidpayload)_
...
_Defined in [src/utils/payload.ts:545](https://github.com/chain4travel/caminojs/blob/3883166/src/utils/payload.ts#L545)_
