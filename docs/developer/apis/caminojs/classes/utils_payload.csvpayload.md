...
- [constructor](utils_payload.csvpayload#constructor)

### Properties

- [payload](utils_payload.csvpayload#protected-payload)
- [typeid](utils_payload.csvpayload#protected-typeid)

### Methods

- [fromBuffer](utils_payload.csvpayload#frombuffer)
- [getContent](utils_payload.csvpayload#getcontent)
- [getPayload](utils_payload.csvpayload#getpayload)
- [returnType](utils_payload.csvpayload#returntype)
- [toBuffer](utils_payload.csvpayload#tobuffer)
- [typeID](utils_payload.csvpayload#typeid)
- [typeName](utils_payload.csvpayload#typename)

## Constructors

### constructor

\+ **new CSVPayload**(`payload`: any): _[CSVPayload](utils_payload.csvpayload)_
...
**Returns:** _[CSVPayload](utils_payload.csvpayload)_
...
_Defined in [src/utils/payload.ts:614](https://github.com/chain4travel/caminojs/blob/3883166/src/utils/payload.ts#L614)_
