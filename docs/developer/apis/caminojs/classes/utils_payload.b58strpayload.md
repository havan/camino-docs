...
- [PayloadBase](utils_payload.payloadbase)
  ...
  ↳ [SECPSIGPayload](utils_payload.secpsigpayload)

  ↳ [SECPENCPayload](utils_payload.secpencpayload)

  ↳ [IPFSPayload](utils_payload.ipfspayload)

## Index

### Constructors

- [constructor](utils_payload.b58strpayload#constructor)

### Properties

- [payload](utils_payload.b58strpayload#protected-payload)
- [typeid](utils_payload.b58strpayload#protected-typeid)

### Methods

- [fromBuffer](utils_payload.b58strpayload#frombuffer)
- [getContent](utils_payload.b58strpayload#getcontent)
- [getPayload](utils_payload.b58strpayload#getpayload)
- [returnType](utils_payload.b58strpayload#returntype)
- [toBuffer](utils_payload.b58strpayload#tobuffer)
- [typeID](utils_payload.b58strpayload#typeid)
- [typeName](utils_payload.b58strpayload#typename)

## Constructors

### constructor

\+ **new B58STRPayload**(`payload`: any): _[B58STRPayload](utils_payload.b58strpayload)_
...
**Returns:** _[B58STRPayload](utils_payload.b58strpayload)_
...
_Defined in [src/utils/payload.ts:352](https://github.com/chain4travel/caminojs/blob/3883166/src/utils/payload.ts#L352)_
