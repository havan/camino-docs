...
- [constructor](api_evm_outputs.secptransferoutput#constructor)

### Properties

- [\_codecID](api_evm_outputs.secptransferoutput#protected-_codecid)
- [\_typeID](api_evm_outputs.secptransferoutput#protected-_typeid)
- [\_typeName](api_evm_outputs.secptransferoutput#protected-_typename)
- [addresses](api_evm_outputs.secptransferoutput#protected-addresses)
- [amount](api_evm_outputs.secptransferoutput#protected-amount)
- [amountValue](api_evm_outputs.secptransferoutput#protected-amountvalue)
- [locktime](api_evm_outputs.secptransferoutput#protected-locktime)
- [numaddrs](api_evm_outputs.secptransferoutput#protected-numaddrs)
- [threshold](api_evm_outputs.secptransferoutput#protected-threshold)

### Methods

- [clone](api_evm_outputs.secptransferoutput#clone)
- [create](api_evm_outputs.secptransferoutput#create)
- [deserialize](api_evm_outputs.secptransferoutput#deserialize)
- [fromBuffer](api_evm_outputs.secptransferoutput#frombuffer)
- [getAddress](api_evm_outputs.secptransferoutput#getaddress)
- [getAddressIdx](api_evm_outputs.secptransferoutput#getaddressidx)
- [getAddresses](api_evm_outputs.secptransferoutput#getaddresses)
- [getAmount](api_evm_outputs.secptransferoutput#getamount)
- [getCodecID](api_evm_outputs.secptransferoutput#getcodecid)
- [getLocktime](api_evm_outputs.secptransferoutput#getlocktime)
- [getOutputID](api_evm_outputs.secptransferoutput#getoutputid)
- [getSpenders](api_evm_outputs.secptransferoutput#getspenders)
- [getThreshold](api_evm_outputs.secptransferoutput#getthreshold)
- [getTypeID](api_evm_outputs.secptransferoutput#gettypeid)
- [getTypeName](api_evm_outputs.secptransferoutput#gettypename)
- [makeTransferable](api_evm_outputs.secptransferoutput#maketransferable)
- [meetsThreshold](api_evm_outputs.secptransferoutput#meetsthreshold)
- [sanitizeObject](api_evm_outputs.secptransferoutput#sanitizeobject)
- [select](api_evm_outputs.secptransferoutput#select)
- [serialize](api_evm_outputs.secptransferoutput#serialize)
- [toBuffer](api_evm_outputs.secptransferoutput#tobuffer)
- [toString](api_evm_outputs.secptransferoutput#tostring)
- [comparator](api_evm_outputs.secptransferoutput#static-comparator)

## Constructors

### constructor

\+ **new SECPTransferOutput**(`amount`: BN, `addresses`: Buffer[], `locktime`: BN, `threshold`: number): _[SECPTransferOutput](api_evm_outputs.secptransferoutput)_
...
**Returns:** _[SECPTransferOutput](api_evm_outputs.secptransferoutput)_
...
• **\_typeID**: _number_ = EVMConstants.SECPXFEROUTPUTID

_Overrides [AmountOutput](api_evm_outputs.amountoutput).[\_typeID](api_evm_outputs.amountoutput#protected-_typeid)_

_Defined in [src/apis/evm/outputs.ts:86](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/evm/outputs.ts#L86)_
...
_Overrides [AmountOutput](api_evm_outputs.amountoutput).[\_typeName](api_evm_outputs.amountoutput#protected-_typename)_

_Defined in [src/apis/evm/outputs.ts:85](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/evm/outputs.ts#L85)_
...
_Defined in [src/apis/evm/outputs.ts:101](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/evm/outputs.ts#L101)_
...
_Defined in [src/apis/evm/outputs.ts:97](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/evm/outputs.ts#L97)_
...
_Defined in [src/apis/evm/outputs.ts:93](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/evm/outputs.ts#L93)_
...
_Inherited from [AmountOutput](api_evm_outputs.amountoutput).[makeTransferable](api_evm_outputs.amountoutput#maketransferable)_
...
_Inherited from [AmountOutput](api_evm_outputs.amountoutput).[select](api_evm_outputs.amountoutput#select)_
