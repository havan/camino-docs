...
↳ [SECPTransferOutput](api_platformvm_outputs.secptransferoutput)

↳ [StakeableLockOut](api_platformvm_outputs.stakeablelockout)

## Index

### Constructors

- [constructor](api_platformvm_outputs.amountoutput#constructor)

### Properties

- [\_codecID](api_platformvm_outputs.amountoutput#protected-_codecid)
- [\_typeID](api_platformvm_outputs.amountoutput#protected-_typeid)
- [\_typeName](api_platformvm_outputs.amountoutput#protected-_typename)
- [addresses](api_platformvm_outputs.amountoutput#protected-addresses)
- [amount](api_platformvm_outputs.amountoutput#protected-amount)
- [amountValue](api_platformvm_outputs.amountoutput#protected-amountvalue)
- [locktime](api_platformvm_outputs.amountoutput#protected-locktime)
- [numaddrs](api_platformvm_outputs.amountoutput#protected-numaddrs)
- [threshold](api_platformvm_outputs.amountoutput#protected-threshold)

### Methods

- [clone](api_platformvm_outputs.amountoutput#abstract-clone)
- [create](api_platformvm_outputs.amountoutput#abstract-create)
- [deserialize](api_platformvm_outputs.amountoutput#deserialize)
- [fromBuffer](api_platformvm_outputs.amountoutput#frombuffer)
- [getAddress](api_platformvm_outputs.amountoutput#getaddress)
- [getAddressIdx](api_platformvm_outputs.amountoutput#getaddressidx)
- [getAddresses](api_platformvm_outputs.amountoutput#getaddresses)
- [getAmount](api_platformvm_outputs.amountoutput#getamount)
- [getCodecID](api_platformvm_outputs.amountoutput#getcodecid)
- [getLocktime](api_platformvm_outputs.amountoutput#getlocktime)
- [getOutputID](api_platformvm_outputs.amountoutput#abstract-getoutputid)
- [getSpenders](api_platformvm_outputs.amountoutput#getspenders)
- [getThreshold](api_platformvm_outputs.amountoutput#getthreshold)
- [getTypeID](api_platformvm_outputs.amountoutput#gettypeid)
- [getTypeName](api_platformvm_outputs.amountoutput#gettypename)
- [makeTransferable](api_platformvm_outputs.amountoutput#maketransferable)
- [meetsThreshold](api_platformvm_outputs.amountoutput#meetsthreshold)
- [sanitizeObject](api_platformvm_outputs.amountoutput#sanitizeobject)
- [select](api_platformvm_outputs.amountoutput#select)
- [serialize](api_platformvm_outputs.amountoutput#serialize)
- [toBuffer](api_platformvm_outputs.amountoutput#tobuffer)
- [toString](api_platformvm_outputs.amountoutput#tostring)
- [comparator](api_platformvm_outputs.amountoutput#static-comparator)

## Constructors

### constructor

\+ **new AmountOutput**(`amount`: BN, `addresses`: Buffer[], `locktime`: BN, `threshold`: number): _[AmountOutput](api_platformvm_outputs.amountoutput)_
...
**Returns:** _[AmountOutput](api_platformvm_outputs.amountoutput)_
...
_Defined in [src/apis/platformvm/outputs.ts:94](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/platformvm/outputs.ts#L94)_
...
_Defined in [src/apis/platformvm/outputs.ts:93](https://github.com/chain4travel/caminojs/blob/3883166/src/apis/platformvm/outputs.ts#L93)_
