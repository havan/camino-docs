...
- [constructor](utils_payload.assetidpayload#constructor)

### Properties

- [payload](utils_payload.assetidpayload#protected-payload)
- [typeid](utils_payload.assetidpayload#protected-typeid)

### Methods

- [fromBuffer](utils_payload.assetidpayload#frombuffer)
- [getContent](utils_payload.assetidpayload#getcontent)
- [getPayload](utils_payload.assetidpayload#getpayload)
- [returnType](utils_payload.assetidpayload#returntype)
- [toBuffer](utils_payload.assetidpayload#tobuffer)
- [typeID](utils_payload.assetidpayload#typeid)
- [typeName](utils_payload.assetidpayload#typename)

## Constructors

### constructor

\+ **new ASSETIDPayload**(`payload`: any): _[ASSETIDPayload](utils_payload.assetidpayload)_
...
**Returns:** _[ASSETIDPayload](utils_payload.assetidpayload)_
...
_Defined in [src/utils/payload.ts:524](https://github.com/chain4travel/caminojs/blob/3883166/src/utils/payload.ts#L524)_
